...
<body>
    ...
    <form id="formularioProductos" action="http://localhost:8080/tecweb/practicas/p10/update_producto.php" method="post">
    ...
    <h2>Información del productos</h2>
      ...
      <fieldset>
        ...
        <ul>
          ...
          <li><label for="form-id">id:</label> <input disabled="true" type="text" name="id" id="form-id" value="<?= !empty($_POST['id'])?$_POST['id']:$_GET['id'] ?>"></li>
